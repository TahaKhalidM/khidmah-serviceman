...
class AppConstants {
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.syria, languageName: 'العربية', countryCode: 'SA', languageCode: 'ar'),
